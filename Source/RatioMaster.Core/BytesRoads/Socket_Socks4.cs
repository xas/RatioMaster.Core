...
namespace BytesRoad.Net.Sockets
{
    ...
    /// </summary>
    public class Socket_Socks4 : SocketBase
    {
        ...
        override public EndPoint LocalEndPoint { get { return _localEndPoint; } }

        override public EndPoint RemoteEndPoint { get { return _remoteEndPoint; } }
        #endregion
